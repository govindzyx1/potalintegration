...
public class AddNewContactGroupAction extends HttpServlet {
	/**
	 * 
	 */
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			flag = new NotesDelegate().addContactGroup(notesDTO);
			if (flag) {
				path = UtilConstants._STATUS;
				request.setAttribute(UtilConstants._STATUS_STRING,
						UtilConstants._CONTACT_GROUP_ADDED_SUCCESS);
			} else {
				path = UtilConstants._STATUS;
				request.setAttribute(UtilConstants._STATUS_STRING,
						UtilConstants._CONTACT_GROUP_ADDED_FAIL);
			}
