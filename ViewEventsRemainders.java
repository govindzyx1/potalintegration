...
public class ViewEventsRemainders extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			opv = new NotesDelegate().viewRemainders((Integer) session
					.getAttribute("userid"), request.getParameter("type"));
			if (!opv.isEmpty()) {
